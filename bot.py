...
def send_gif(message):
    chat_id = message.chat.id
    gif_path = '/home/SpasiboTaras/image2.gif'  # путь к вашему GIF-файлу
...
def send_gif(message):
    chat_id = message.chat.id
    gif_path = '/home/SpasiboTaras/image3.gif'  # путь к вашему GIF-файлу
